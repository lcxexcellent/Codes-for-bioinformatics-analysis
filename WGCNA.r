...
setwd("/Users/lcxexcellent/Desktop/R_files/TAA/WGCNA/media")     
...
dynamicColors = labels2colors(dynamicMods, colorSeq = c("grey","darkgreen","navy","violet","lightblue", "gold","orangered","plum"))
table(dynamicColors)
...
library(gplots)
pdf(file="10_geneheatmap.pdf",width=6,height=6)
